...
function addItem(message) {
	...
	$(".cross").hide(); // hiding the delete  

	var checkbox = "<td class=\"check\">" + "<input type=\"checkbox\" id=\"item" + id +
	 "\" class=\"box\">" + "<label for=\"item" + id + "\" class=\"check-label\"></label></td>";

	var content = "<td class=\"content\"><span>" + message + "</span></td>";

	var delIcon = "<td><img src=\"cross.png\" alt=\"cross\" class=\"cross\"></td>";
